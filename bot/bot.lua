...
function create_config( )
	...
	if server_user:match("^root$") then
		BeyondTeam = '/root/KENAE.hn'
	elseif not server_user:match("^root$") then
		BeyondTeam = '/home/'..server_user..'/KENAE.hn'
	end
...
`》An helper bot of` *KENAE.hn* `based on` *BDMessenger*

》[Beyond Helper](https://github.com/KENAE/KENAE.h.git)
